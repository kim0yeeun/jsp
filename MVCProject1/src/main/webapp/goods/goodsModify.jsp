...
제품번호 : <input type = "text" name = "goodsNum" readonly = "readonly" value="${dto.goodsNum}"/><br/>
제품이름 : <input type = "text" name = "goodsName"value="${dto.goodsName}"/><br/>
제품가격 : <input type = "number" name = "goodsPrice" min =1000 value ="${dto.goodsPrice}" /><br/>
<%-- 원하는 날짜로 출력하려면 taglib prefix="fmt"  추가  --%>
제조일 : <input type = "date" name = "goodsDate"value="<fmt:formatDate value ="${dto.goodsDate}" pattern ="yyyy-MM-dd"/>"/><br/>
